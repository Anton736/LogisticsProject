...
class DinkelbachOrchestrator:
    def __init__(self,
                 ...
                 objective_scale_factor: int = 100):  # Для ObjBuilder
        ...
        self.solver.parameters.max_time_in_seconds = 1200.0  # 10 минут, для больших задач может быть увеличено
    ...
    def solve(self, epsilon: float = 1e-6, max_iterations: int = 10) -> Optional[Solution]:
        """
        ...
        """
        best_lambda = 1.0  # Начальное значение лямбда
        ...
        LAMBDA_SCALE_FACTOR = 10  # 5 знаков после запятой для лямбда
